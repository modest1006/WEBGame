(function () {
  ...
  function installPetriDebug(game, renderer) {
    ...
    function update() {
      ...
      el.textContent = [
        'PETRI debug',
        'gen=' + s.generation + ' pop=' + s.population + ' spores=' + s.spores + ' gauge=' + s.gauge + ' food=' + s.nutrientAverage.toFixed(1) + ' nextSpore=' + s.nextNaturalGeneration,
    ...
    window.__game = {
      ...
      feed: function (x, y, r) { game.restoreNutrition(x || 70, y || 70, r || 16); game.save(); return game.getState(); },
